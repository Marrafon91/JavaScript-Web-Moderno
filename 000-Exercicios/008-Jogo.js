...
function avaliaDesempenho(pontuacoesStr) {
  let pontuacoes = pontuacoesStr.split(" ").map(Number);
  let recordes = 0;
  let piorJOgo = 1;
...
console.log(avaliaDesempenho("10 20 20 8 25 3 0 30 1"));
console.log(`###############`);

let stringPontuacoes = "30, 40, 20, 4, 51, 25, 0, 42, 56, 38"
